...
cta:
  ...
  label: "Talk through your selling timeline →"
  href: "/get-started/"
sources:
  - { label: "Wisconsin Legislature, Statute 77.22 (real estate transfer fee)", url: "https://docs.legis.wisconsin.gov/statutes/statutes/77/ii/22" }
  - { label: "Wisconsin Department of Revenue, real estate transfer fee FAQs", url: "https://www.revenue.wi.gov/Pages/FAQS/slf-retr-retr-t.aspx" }
...
Wisconsin charges a state real estate transfer fee on the sale, and by custom the seller pays it. The rate is 30 cents per $100 of value, which works out to **$3 per $1,000 of the sale price**, or 0.3 percent ([Wisconsin Statute 77.22](https://docs.legis.wisconsin.gov/statutes/statutes/77/ii/22); [Wisconsin DOR](https://www.revenue.wi.gov/Pages/FAQS/slf-retr-retr-t.aspx)). On a $300,000 sale that is $900. It is collected when the deed is recorded.

## Prorated property taxes

Wisconsin pays property taxes in arrears, which affects sellers directly. At closing you typically credit the buyer for the portion of the current year you owned the home, based on the prior year's tax bill by default ([Wisconsin County Treasurers Association](https://wicountytreasurers.com/index.php/faqs/)). On a home with a $4,800 annual tax bill, a mid-year closing means roughly half of that, about $2,400, comes out of your proceeds as a credit to the buyer. The exact figure depends on your closing date and the proration method in your contract.
